...
class switch_process:
    ...
    def calculatepi_process(self):
        ...
        pi_resultsend=str(pi_result).encode(message_format)
        self.client_connect.send(pi_resultsend)
    ...
    def add_process(self):
        ...
        add_resultsend=(str(add_result).encode(message_format))
        self.client_connect.send(add_resultsend)
    ...
    def sort_process(self):
       ...
       sort_resultsend=list_string.encode(message_format)
       self.client_connect.send(sort_resultsend)
    ...
    def matmultiply_process(self):
        ...
        self.client_connect.send(result_mult.encode(message_format))
